...
![<popupchatter>Updated `r format(Sys.time(), '%B %d, %Y')` by the ABC11 Data Team</popupchatter>](https://github.com/abcotvdata/safetytracker_raleigh/raw/main/docs/banner_placeholder.png)
```{css, echo=FALSE}
