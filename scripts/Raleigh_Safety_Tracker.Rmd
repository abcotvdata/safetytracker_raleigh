...
<div class="card" style="background-color:#99a0a5;">
<p>Average Homicide Rate<br>2022 to 2024<br>
<bignumber>`r murders_city$rate_prior3years`<br></bignumber><p>
Per 100,000 people</p>
</div>
</div>
<br>
Homicides over the last 12 months are trending <h8>`r ifelse(murders_city$inc_24tolast12>=0," up"," down")` `r ifelse(murders_city$inc_24tolast12>=0,murders_city$inc_24tolast12,substring(murders_city$inc_24tolast12,2))`%</h8> compared to 2024, according to the latest data available from the Raleigh Police Department.

The murder rate over the last 12 months is<h8>`r ifelse(murders_city$inc_prior3yearavgtolast12>=0," up"," down")` `r ifelse(murders_city$inc_prior3yearavgtolast12>=0,murders_city$inc_prior3yearavgtolast12,substring(murders_city$inc_prior3yearavgtolast12,2))`%</h8> compared to the annual average over the last three years, and the frequency of killings is lower than it was before the pandemic.
...
ABC11's data team looked at the Raleigh Police Department's data by neighborhood from 2019 through `r format(asofdate, "%B %d, %Y")`.
...
raleigh_murder_map <- leaflet(murders_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
