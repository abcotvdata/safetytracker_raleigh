...
<subhead>A closer look at Raleigh burglaries neighborhood by neighborhood</subhead>
...
raleigh_burglary_map <- leaflet(burglaries_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
