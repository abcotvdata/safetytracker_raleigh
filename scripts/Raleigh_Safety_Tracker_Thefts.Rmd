...
<subhead>Raleigh thefts neighborhood by neighborhood</subhead>
...
raleigh_theft_map <- leaflet(thefts_district, options = leafletOptions(zoomControl = FALSE, zoomSnap = 0.5, zoomDelta=0.5)) %>%
